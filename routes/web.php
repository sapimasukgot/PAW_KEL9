    ...
    Route::middleware(['auth'])->prefix('pembeli')->group(function () {
        ...
        Route::post('/checkout/{id}/simpan', [PembeliController::class, 'storePesanan'])->name('pembeli-checkout.store');
        ...
        Route::get('/pembeli/detail-pesanan/{id}', [PembeliController::class, 'detailpesanan'])->name('pembeli-detail-pesanan');
        ...
        Route::post('/riwayat-detail/{id}/rating', [PembeliController::class, 'storeRating'])->name('pembeli.store-rating');
        Route::get('/rating/{id}', [PembeliController::class, 'rating'])->name('pembeli-rating');
    ...
    Route::middleware(['auth'])->group(function () {
        Route::get('/penjual-beranda', [PenjualController::class, 'beranda'])->name('penjual-beranda');
        ...
        Route::get('/pesanan-penjual', [PenjualController::class, 'pesanan'])->name('pesanan-penjual');
        ...
        Route::get('/riwayat-penjual', [PenjualController::class, 'riwayat'])->name('riwayat-penjual');
        Route::get('/riwayat-penjual-detail/{id}', [PenjualController::class, 'riwayatDetail'])->name('riwayat-penjual-detail');
        Route::post('/pesanan-detail/{id}/update-status', [PenjualController::class, 'updateStatus'])->name('penjual.update-status');

        Route::get('/ulasan-penjual', [PenjualController::class, 'ulasan'])->name('ulasan-penjual');
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::get('/admin/tambah-toko', [AdminController::class, 'createToko'])->name('admin.tambah_toko');
        Route::post('/admin/store-toko', [AdminController::class, 'storeToko'])->name('admin.store_toko'); 
        Route::post('/admin/delete-toko/{id}', [AdminController::class, 'deleteToko'])->name('admin.delete_toko');
    });