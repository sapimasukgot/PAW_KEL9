...
<body class="bg-[#fcebda] min-h-screen">
    <div class="max-w-2xl mx-auto p-4">
        ...
        <div class="bg-white p-4 rounded-3xl shadow-lg flex flex-col md:flex-row gap-6 mb-6">
            ...
            <div class="flex-1">
                <h4 class="font-bold text-lg" data-translate="label_desc">Deskripsi</h4>
                <p class="text-sm text-gray-600 leading-relaxed">
                    {{ $menu['nama'] }} <span data-translate="desc_generic">adalah salah satu menu yang cukup digemari pelanggan, terlebih karena rasanya yang gurih dan aromanya yang menggugah selera.</span>
                </p>
            </div>
        </div>
        ...
        <div class="border-2 border-dashed border-blue-400 rounded-2xl p-4 bg-white/50 mb-10">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div class="bg-[#d9d9d9] p-3 rounded-xl text-center">
                    <h5 class="font-bold mb-2" data-translate="label_price_detail">Detail Harga</h5>
                    <p class="text-xs">Jumbo: Rp14.000</p>
                    <p class="text-xs">Reguler: Rp10.000</p>
                </div>
                <div class="bg-[#d9d9d9] p-3 rounded-xl text-center">
                    <h5 class="font-bold mb-2" data-translate="label_topping">Topping</h5>
                    <p class="text-xs">Katsu - Rp 4.000</p>
                    <p class="text-xs">Kulit - Rp 3.000</p>
                    <p class="text-xs">Telur - Rp 4.000</p>
                </div>
                <div class="bg-[#d9d9d9] p-3 rounded-xl text-center">
                    <h5 class="font-bold mb-2 text-sm" data-translate="label_spicy_level">Level Pedas</h5>
                    <p class="text-xs">Level 0 - 2</p>
                </div>
            </div>

            <div class="space-y-3">
                <h5 class="font-bold italic" data-translate="label_review">Review</h5>
        ...
        <div class="flex justify-between items-center px-4">
            <a href="{{ route('pembeli-beranda') }}" class="bg-[#d1d1d1] px-8 py-2 rounded-lg font-bold transition hover:bg-gray-400" data-translate="btn_back">Kembali</a>
            <a href="{{ route('pembeli-checkout', $menu['id']) }}" class="bg-[#d1d1d1] px-10 py-2 rounded-lg font-bold transition hover:bg-gray-400" data-translate="btn_order">Pesan</a>
        </div>
    </div>
</body>
</html>