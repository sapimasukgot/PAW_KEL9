...
@section('content')
    <div class="flex flex-col h-[calc(100vh-180px)]">
        <h2 class="text-2xl font-bold text-center mb-6 flex-none" data-translate="title_customer_history">Riwayat Pesanan
            Pelanggan</h2>
            ...
            <div class="space-y-4">
                ...
                @forelse($histories as $data)
                    <div class="bg-white p-4 rounded-2xl shadow-sm flex items-start gap-4 mb-4 border border-gray-50">
                        <div
                            class="w-16 h-16 bg-gray-200 rounded-full flex-shrink-0 flex items-center justify-center font-bold text-gray-600 uppercase text-xl">
                        ...
                        <div class="flex-grow">
                            ...
                            <p class="text-xs text-gray-400 mt-1">Status transaksi: <span
                                    class="text-emerald-500 font-bold">{{ $data->status }}</span></p>
                        </div>

                        <div class="flex flex-col items-end gap-3 self-stretch justify-between">
                            <span class="font-bold text-sm text-gray-800">Rp
